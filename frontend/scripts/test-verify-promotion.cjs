...
function main() {
  ...
  assert(defaultScripts.includes('acceptance:launch:test'), 'plan should test manual acceptance launcher')
  ...
  assertBefore(defaultScripts, 'acceptance:launch:test', 'release:check-signatures')
